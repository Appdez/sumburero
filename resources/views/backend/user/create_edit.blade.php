                        ...
                        <div class="container row">
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input name="name"
                                        ...
                                        type="text" class="form-control" placeholder="Nome de usuário" autofocus
                            ...
                            <div class="row justify-content-between mb-3">
                                ...
                                <div class="row col-md-6">
                                    ...
                                    <input name="email"
                                        ...
                                        type="email" class="form-control" placeholder="Nome do email" autofocus
                                        ...
                                        <optgroup label="Previlêgios">
                                            @foreach (\Spatie\Permission\Models\Role::all() as $role)
                                                <option value="{{ $role->id }}"
                                                    @if (request()->routeIs('user.edit') && $role->id == $user->roles->first()->id) selected="true" @endif>
                                                    {{ $role->name }}
                                                </option>
                                            @endforeach
                                        </optgroup>
                            ...
                            <div class="row justify-content-between mb-3">
                                <div class="row col-md-6">
                                    ...
                                    <input name="password" type="password" class="form-control" placeholder="Senha"
                                        autofocus autocomplete="" @if (!request()->routeIs('user.edit')) required @endif
                                ...
                                <div class="row col-md-6">
                                    ...
                                    <input name="password_confirmation" type="password" class="form-control"
                                        ...
                                        @if (!request()->routeIs('user.edit')) required @endif
                            ...
                            <div class="container justify-content-center row">
                                <input type="submit" class="btn btn-primary rounded-3 col"
                                    value="@if (request()->routeIs('user.edit')) Actualizar @else Guardar @endif">
                            </div>
                        </div>
                    </div>
                </div>
